...
public class RequestMaker {
    ...
    private static class Requester extends AsyncTask<String, String, String> {
        ...
        private Requester(OnRequestListener listener) {
        ...
        private String getResourceUri(String uri) {
            ...
            try {
                URL url = new URL(uri); // Указать адрес
                urlConnection = (HttpsURLConnection) url.openConnection();
                urlConnection.setRequestMethod("GET"); // установка метода получения данных - GET
                urlConnection.setReadTimeout(10000);   // установка таймаута - 10 секунд
                ...
                BufferedReader in = new BufferedReader(new InputStreamReader(
                        urlConnection.getInputStream())); // читаем  данные в поток ввода/вывода
                ...
                while ((line = in.readLine()) != null) {
                    ...
                    buf.append(System.getProperty("line.separator")); // новая строка
                }
                return buf.toString();
            }
            catch (Exception exception) {
                Log.e("WebBrowser", "failed", exception);
